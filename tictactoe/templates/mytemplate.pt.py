...
def bind():
    ...
    _attrs_181905260 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_181903468 = _loads('(dp1\n.')
    _attrs_181882732 = _loads('(dp1\n.')
    _attrs_181904172 = _loads('(dp1\n.')
    _attrs_181903980 = _loads('(dp1\n.')
    _attrs_181904428 = _loads('(dp1\n.')
    _attrs_181904940 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_181903724 = _loads('(dp1\n.')
    _attrs_181905996 = _loads('(dp1\nVhref\np2\nV/\ns.')
    _attrs_181905580 = _loads('(dp1\nVhref\np2\nV?row=${repeat.row.number}&col=${repeat.cell.number}\np3\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_181904652 = _loads('(dp1\nVid\np2\nVboard\np3\ns.')
    _attrs_181905164 = _loads('(dp1\n.')
    ...
    def render(econtext, rcontext=None):
        ...
        _domain = None
        _write('<!DOCTYPE html>\n')
        attrs = _attrs_181882732
        _write(u'<html>\n  ')
        attrs = _attrs_181903468
        _write(u'<head>\n    ')
        attrs = _attrs_181903724
        _write(u'<title>Tic! Tac!  And even Toe!</title>\n    ')
        attrs = _attrs_181903980
        _write(u'<style>\n      #board {\n        border-collapse: collapse;\n      }\n      #board td {\n        width: 10em;\n        height: 10em;\n        border: 1px solid black;\n        text-align: center;\n      }\n      #board td a:hover {\n        background-color: #668800;\n      }\n      #board td a {\n        width: 2em;\n        height: 2em;\n        display: block;\n        font-size: 5em;\n        text-decoration: none;\n        line-height: 2em;\n      }\n    </style>\n  </head>\n  ')
        attrs = _attrs_181904172
        _write(u'<body>\n    ')
        attrs = _attrs_181904428
        _write(u'<p>Your move.</p>\n    ')
        attrs = _attrs_181904652
        u'board'
        ...
        for row in _tmp1:
            ...
            for cell in _tmp3:
                _tmp4 = (_tmp4 - 1)
                attrs = _attrs_181905260
                _write(u'<td>')
                attrs = _attrs_181905580
            ...
            _write(' ')
        _write(u'\n    </table>\n    ')
        attrs = _attrs_181905164
        _write(u'<p>')
        attrs = _attrs_181905996
